...
$query = "SELECT * FROM `Index_$lang` WHERE `Page` = 'Index'";
...
<!--<![endif]-->
<head>
<meta name="google-site-verification" content="rbXr9QHTR32UOGRsT3NsOY9tU5zarXFp9TowajRiHBI" />
	...
	<title>Салон свадебных платьев Wedding Salon Ksena</title>
	<meta name="description" content="Салон свадебных платьев wedding salon ksena предлагает широкий выбор моделей и большой ассортимент новых моделей." />
    <meta name="keywords" content="Купить свадебное платье, Салон свадебных платьев, Свадебные платья цена, wedding salon, wedding salon ksena" />
...
(w[c] = w[c] || []).push(function() { 
try { 
w.yaCounter37334435 = new Ya.Metrika({ 
id:37334435, 
clickmap:true, 
trackLinks:true, 
accurateTrackBounce:true 
...
<noscript><div><img src="https://mc.yandex.ru/watch/37334435" style="position:absolute; left:-9999px;" alt="" /></div></noscript> 
<!— /Yandex.Metrika counter —>


<div class="load-site">
		
	<img src="img/loading.gif" height="598" width="398" alt="" />

</div><!-- end load-site -->

<div class="wrapper out fade parallax-window" data-parallax="scroll" data-image-src="img/bg.jpg">
						...
						<div class="col-md-12">
							...
							<div class="main-menu">
								...
								<nav>
									...
									<ul>
										<a href="/" class="active"><li><?=$Interface['Index']?></li></a>
										<a href="pages/collection.php"><li><?=$Interface['Collection']?></li></a>
										<a href="pages/about.php"><li class="about"><?=$Interface['About']?></li></a>
										<a href="pages/articles.php"><li class="articles"><?=$Interface['Articles']?></li></a>
										<a href="pages/partner.php"><li class="partner"><?=$Interface['Partner']?></li></a>
										<a href="pages/contacts.php"><li><?=$Interface['Contacts']?></li></a>
									</ul>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div id="carousel">
	    			...
	    			<a href="#"><img src="img/holovna-gallery/IMG_0091.jpg" height="3648" width="5472" class="my-foto" /></a>

	    			<a href="#"><img src="img/holovna-gallery/IMG_0116.jpg" height="3648" width="5472" /></a>

	    			<a href="#"><img src="img/holovna-gallery/IMG_0119.jpg" height="3648" width="5472" /></a>

	    			<a href="#"><img src="img/holovna-gallery/IMG_0152.jpg" height="3508" width="5262" /></a>

	    			<a href="#"><img src="img/holovna-gallery/IMG_0153.jpg" height="3648" width="5472" /></a>

	    			<a href="#"><img src="img/holovna-gallery/IMG_0155.jpg" height="3530" width="5295" /></a>

	    			<a href="#"><img src="img/holovna-gallery/IMG_0168.jpg" height="3648" width="5472" /></a>

	    			<a href="#"><img src="img/holovna-gallery/IMG_0169.jpg" height="3648" width="5472" /></a>

	    			<a href="#"><img src="img/holovna-gallery/IMG_0221.jpg" height="3648" width="5472" /></a>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="logo-bottom">
							...
							<a href=""><img src="img/logo-bottom.png" height="113" width="222" alt="Wedding Salon Ksena"></a>
						...
						<div class="bottom-menu">
							...
							<nav>
								...
								<ul>
									<a href="/" class="active"><li><?=$Interface['Index']?></li></a>
									<a href="pages/collection.php"><li><?=$Interface['Collection']?></li></a>
									<a href="pages/about.php"><li><?=$Interface['About']?></li></a>
									<a href="pages/articles.php"><li><?=$Interface['Articles']?></li></a>
                                    <a href="pages/partner.php"><li class="partner"><?=$Interface['Partner']?></li></a>
									<a href="pages/contacts.php"><li><?=$Interface['Contacts']?></li></a>
								</ul>
...
<script src="libs/zoom/zoomsl-3.0.min.js"></script>
