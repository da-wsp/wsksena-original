...
$query = "SELECT * FROM `Index_$lang` WHERE `Page` = 'Partner'";
...
<head>
	...
	<title>Свадебные платья оптом от производителя</title>
	<meta name="description" content="Для своих партнёров, салон свадебных платьев Ksena, предлагает лучшие условия для сотрудничества и ведения бизнеса" />
    <meta name="keywords" content="Свадебные платья от производителя, Свадебные платья Черновцы, Купить свадебные платья" />
							...
							<div class="main-menu">
								...
								<nav>
									...
									<ul>
										...
										<a href="partner.php" class="active"><li class="partner"><?=$Interface['Partner']?></li></a>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<span>&copy;2016 Розроблено</span>
