...
<head>
	...
	<title>Свадебные платья от ТМ “Ксена”</title>
	<meta name="description" content="Свадебные платья от ТМ Ксена – это купить свадебные платья оптом, модные свадебные платья, пышные свадебные платья, прямые свадебные платья." />
        <meta name="keywords" content="пышные свадебные платья, продажа свадебных платьев, модные свадебные платья, прямые свадебные платья, свадебные платья оптом" />
							...
							<div class="main-menu">
								...
								<nav>
									...
									<ul>
										...
										<a href="articles.php" class="active"><li class="articles"><?=$Interface['Articles']?></li></a>
						...
						<div class="bottom-menu">
							...
							<nav>
								...
								<ul>
									...
									<a href="articles.php" class="active"><li><?=$Interface['Articles']?></li></a>
                                    <a href="partner.php"><li class="partner"><?=$Interface['Partner']?></li></a>
									<a href="contacts.php"><li><?=$Interface['Contacts']?></li></a>
								</ul>
