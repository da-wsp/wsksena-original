...
$query = "SELECT * FROM `Dresses_$lang` WHERE `Id`=".intval($_GET['Id']);
$Dress = mysqli_fetch_assoc(mysqli_query($db,$query));
...
<head>
	...
	<title>Wedding Salon Ksena</title>
	<meta name="description" content="" />
        <meta name="keywords" content="Цены свадебные платья, Дорогие Свадебные платья, Шикарные свадебные платья, Свадебные платья от производителя" />
...
<div id="wrapper">
				...
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-5">
							...
							<div class="languages">
							<form name="lang" method="post" action="/index.php?setlang">
	...
	<span style="disply:none" id="dress_id"><?=$Dress['Id']?></span>
					...
					<div class="content-block">
						...
						<div class="row">
							...
							<div class="col-md-5">
								...
								<div class="photo-dress">

									<b class="loading"></b>
									
									<a href="../img/collections/<?=$Dress['Id']?>.jpg" class="fancybox"><img src="../img/collections/<?=$Dress['Id']?>.jpg" height="5472" width="3648" alt="Ksena" class="main-photo my-foto"></a>

								</div><!-- end photo-dress -->

								<div class="photo-dress-small">

									<div id="photo-small-block1" class="photo-small-block">
									<?php
										if (is_file('../img/collections/'.$Dress['Id'].'/1.jpg')) {
									?><img onclick="change_img(this)" src="../img/collections/<?=$Dress['Id']?>/1.jpg" height="400" width="600" alt="Ksena"><?php } ?>
									</div>
									<div id="photo-small-block2"  class="photo-small-block">
									<?php
										if (is_file('../img/collections/'.$Dress['Id'].'/2.jpg')) {
									?><img onclick="change_img(this)" src="../img/collections/<?=$Dress['Id']?>/2.jpg" height="400" width="600" alt="Ksena"><?php } ?>
									</div>
									<div id="photo-small-block3" class="photo-small-block">
									<?php
										if (is_file('../img/collections/'.$Dress['Id'].'/3.jpg')) {
									?><img onclick="change_img(this)" src="../img/collections/<?=$Dress['Id']?>/3.jpg" height="400" width="600" alt="Ksena"><?php } ?>
									</div>
									<div id="photo-small-block4" class="photo-small-block">
									<?php
										if (is_file('../img/collections/'.$Dress['Id'].'/4.jpg')) {
									?><img onclick="change_img(this)" src="../img/collections/<?=$Dress['Id']?>/4.jpg" height="400" width="600" alt="Ksena"><?php } ?>
									</div>
									
								</div><!-- photo-dress-small -->
							...
							<div class="col-md-7">
								...
								<div class="block-inf">
									...
									<div class="buttuns-list-collections">
										
										<div style="cursor:pointer" onclick="dress('before')" class="button button-prev">_</div>
										<a href="collection.php"><div class="button back-coll"><?=$Interface['Collection']?></div></a>
										<div style="cursor:pointer" onclick="dress('next')" class="button button-next">_</div>

										<!--<a href=""><div class="button button-prev"></div></a>
										<div class="button back-coll"><a href="">В колекцію</a></div>
										<a href=""><div class="button button-next"></div></a>-->

									</div><!-- end buttuns-list-collections -->

									<center><h1><?=$Dress['Name']?></h1></center>

									<div class="text-for-coll">
										
									<?=$Dress['About']?>

									</div><!-- end text-for-coll -->
